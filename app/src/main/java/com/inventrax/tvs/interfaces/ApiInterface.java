...
public interface ApiInterface {
    ...
    // to get the obdrefnumbers in the internal transfer and workorder and obdpicking
   ...
   @POST("Outbound/GetPackingCartonInfo")
    ...
    //calls  when click on transfer complete in internaltransfer
   ...
   //calls after  click on SKU    in internal transfer(retuns the SKULIST)
    @POST("Transfers/GetSKUList")
    Call<String>GetSKUList(@Body WMSCoreMessage oRequest);

   // calls after  click on SKU    in internal transfer(retuns the Locationslist of SKU)
    @POST("Transfers/GetLocationsBySKU")
    Call<String> GetLocationsBySKU(@Body WMSCoreMessage oRequest);

   // (retuns the DOCKLocationslist in Internal transfer)
    @POST("Transfers/GetDockLocations")
    Call<String> GetDockLocations(@Body WMSCoreMessage oRequest);

    // calls when click on pick complete buttton in internaltransfer
    @POST("Transfers/WorkOrderLineItemComplete")
    Call<String> WorkOrderLineItemComplete(@Body WMSCoreMessage oRequest);

    @POST("Outbound/WorkOrderPicking")
    Call<String> WorkOrderPicking(@Body WMSCoreMessage oRequest);

    @POST("CycleCount/GetCCBlockedLocations")
    Call<String> GetCCBlockedLocations(@Body WMSCoreMessage oRequest);

    @POST("HouseKeeping/UpsertStockTake")
    Call<String> UpsertStockTake(@Body WMSCoreMessage oRequest);


    @POST("Outbound/GetWORefNos")
    Call<String> GetWORefNos(@Body WMSCoreMessage oRequest);

    @POST("Outbound/GetWORevertItemsForPicking")
    Call<String> GetWORevertItemsForPicking(@Body WMSCoreMessage oRequest);


    @POST("Outbound/UpsertHHTWORevert")
    Call<String> UpsertHHTWORevert(@Body WMSCoreMessage oRequest);


    @POST("Transfers/ItemMasterPrint")
    Call<String> ItemMasterPrint(@Body WMSCoreMessage oRequest);



    @POST("VNA/CheckPalletandLocationValidation")
    Call<String> CheckPalletandLocationValidation(@Body WMSCoreMessage oRequest);


    @POST("VNA/VNA_UpsertBintoBinTransfer")
    Call<String> VNA_UpsertBintoBinTransfer(@Body WMSCoreMessage oRequest);



//  vna suggestion for picking, auto and putayay
    @POST("VNA/VNASuggestion")
    Call<String> VNASuggestion(@Body WMSCoreMessage oRequest);

//  pallet scan
    @POST("VNA/VNAPalletScan")
    Call<String> VNAPalletScan(@Body WMSCoreMessage oRequest);

// location scan
 /*   @POST("VNA/UpsertBintoBinTransfer")
    Call<String> UpsertBintoBinTransfer(@Body WMSCoreMessage oRequest);*/

//start suggestion
    @POST("VNA/GeneratePutawayandPickingSuggestion")
    Call<String> GeneratePutawayandPickingSuggestion(@Body WMSCoreMessage oRequest);

// stop suggestion
    @POST("VNA/StopSuggestion")
    Call<String> StopSuggestion(@Body WMSCoreMessage oRequest);


// skip suggestion for picking
    @POST("VNA/VNApickingSkip")
    Call<String> VNApickingSkip(@Body WMSCoreMessage oRequest);

    // skip suggestion for putaway
