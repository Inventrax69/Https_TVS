...
public class SharedPreferencesUtils {
    ...
    private static com.inventrax.tvs.util.SharedPreferencesUtils defaultSharedPreferencesHelper = new com.inventrax.tvs.util.SharedPreferencesUtils(null, null);
    ...
    public static com.inventrax.tvs.util.SharedPreferencesUtils get(String name, Context context) {
        return new com.inventrax.tvs.util.SharedPreferencesUtils(name, context);
    }

    public static com.inventrax.tvs.util.SharedPreferencesUtils get() {
