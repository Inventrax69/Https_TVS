...
public class ScreenUtils {
    ...
    public static String getScreenDensity() {
        ...
        if (com.inventrax.tvs.util.ScreenUtils.isLdpiDensity()) {
            density = LDPI_DENSITY_NAME;
        } else if (com.inventrax.tvs.util.ScreenUtils.isMdpiDensity()) {
            density = MDPI_DENSITY_NAME;
        } else if (com.inventrax.tvs.util.ScreenUtils.isHdpiDensity()) {
            density = HDPI_DENSITY_NAME;
        } else if (com.inventrax.tvs.util.ScreenUtils.isXhdpiDensity()) {
            density = XHDPI_DENSITY_NAME;
        } else if (com.inventrax.tvs.util.ScreenUtils.isTVdpiDensity()) {
            density = TVDPI_DENSITY_NAME;
        } else if (com.inventrax.tvs.util.ScreenUtils.isXXhdpiDensity()) {
            density = XXHDPI_DENSITY_NAME;
        } else if (com.inventrax.tvs.util.ScreenUtils.isXXXhdpiDensity()) {
