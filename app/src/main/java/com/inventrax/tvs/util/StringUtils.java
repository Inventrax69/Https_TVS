...
import com.inventrax.tvs.common.collections.Sets;
...
public abstract class StringUtils {
    ...
    public static String getNotEmptyString(String text) {
        return com.inventrax.tvs.util.StringUtils.isEmpty(text) ? null : text;
    }
    ...
    public static boolean isNotBlank(String str) {
        return !com.inventrax.tvs.util.StringUtils.isBlank(str);
    }
        ...
        if (isNotBlank(text)) {
            ...
            if (text.length() > maxCharacters) {
                if (truncateWords) {
                    ...
                    if (maxCharacters <= com.inventrax.tvs.util.StringUtils.ELLIPSIS.length()) {
                        truncatedTextBuilder.append(text.substring(0, maxCharacters));
                    } else {
                        truncatedTextBuilder.append(text.substring(0, maxCharacters - com.inventrax.tvs.util.StringUtils.ELLIPSIS.length()));
                        truncatedTextBuilder.append(com.inventrax.tvs.util.StringUtils.ELLIPSIS);
                    }
                } else {
    ...
    public static String truncate(String text, Integer maxCharacters) {
        return com.inventrax.tvs.util.StringUtils.truncate(text, maxCharacters, true);
    }
    ...
    public static Set<String> extractPlaceHolders(String string) {
        Matcher matcher = Pattern.compile(com.inventrax.tvs.util.StringUtils.PLACEHOLDER_PATTERN).matcher(string);
    ...
    public static String toAlphanumeric(String value) {
        return Pattern.compile(com.inventrax.tvs.util.StringUtils.ALPHANUMERIC_PATTERN).matcher(value).replaceAll("");
    }
