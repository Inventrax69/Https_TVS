...
public class NavigationDrawerAdapter extends RecyclerView.Adapter<com.inventrax.tvs.adapters.NavigationDrawerAdapter.MyViewHolder> {
    ...
    public static void setSelectedItemPosition(int selectedItemPosition) {
        com.inventrax.tvs.adapters.NavigationDrawerAdapter.selectedItemPosition = selectedItemPosition;
    }
