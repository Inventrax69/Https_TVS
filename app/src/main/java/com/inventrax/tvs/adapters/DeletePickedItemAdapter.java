...
import com.inventrax.tvs.model.Model;
...
public class DeletePickedItemAdapter extends RecyclerView.Adapter<com.inventrax.tvs.adapters.DeletePickedItemAdapter.ViewHolder> {
  ...
  static AlertDialog.Builder alertDialog;
    ...
    @Override
    public com.inventrax.tvs.adapters.DeletePickedItemAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(com.inventrax.tvs.adapters.DeletePickedItemAdapter.ViewHolder holder, int position) {
