...
public class SimpleHttpDownloadStrategy implements DownloadStrategy {
    public static final Creator<com.inventrax.tvs.services.appupdate.SimpleHttpDownloadStrategy> CREATOR =
            new Creator<com.inventrax.tvs.services.appupdate.SimpleHttpDownloadStrategy>() {
                public com.inventrax.tvs.services.appupdate.SimpleHttpDownloadStrategy createFromParcel(Parcel in) {
                    return (new com.inventrax.tvs.services.appupdate.SimpleHttpDownloadStrategy());
                }

                public com.inventrax.tvs.services.appupdate.SimpleHttpDownloadStrategy[] newArray(int size) {
                    return (new com.inventrax.tvs.services.appupdate.SimpleHttpDownloadStrategy[size]);
                }
            };
