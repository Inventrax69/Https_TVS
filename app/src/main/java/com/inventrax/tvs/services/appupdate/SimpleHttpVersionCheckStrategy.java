...
public class SimpleHttpVersionCheckStrategy implements
     ...
     * upon demand.
     */
    public static final Creator<com.inventrax.tvs.services.appupdate.SimpleHttpVersionCheckStrategy> CREATOR =
            new Creator<com.inventrax.tvs.services.appupdate.SimpleHttpVersionCheckStrategy>() {
                public com.inventrax.tvs.services.appupdate.SimpleHttpVersionCheckStrategy createFromParcel(Parcel in) {
                    return (new com.inventrax.tvs.services.appupdate.SimpleHttpVersionCheckStrategy(in));
                }

                public com.inventrax.tvs.services.appupdate.SimpleHttpVersionCheckStrategy[] newArray(int size) {
                    return (new com.inventrax.tvs.services.appupdate.SimpleHttpVersionCheckStrategy[size]);
                }
            };
