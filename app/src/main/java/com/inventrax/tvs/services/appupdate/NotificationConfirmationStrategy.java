...
package com.inventrax.tvs.services.appupdate;
...
public class NotificationConfirmationStrategy implements
     ...
     * upon demand.
     */
    public static final Creator<com.inventrax.tvs.services.appupdate.NotificationConfirmationStrategy> CREATOR =
            new Creator<com.inventrax.tvs.services.appupdate.NotificationConfirmationStrategy>() {
                public com.inventrax.tvs.services.appupdate.NotificationConfirmationStrategy createFromParcel(Parcel in) {
                    return (new com.inventrax.tvs.services.appupdate.NotificationConfirmationStrategy(in));
                }

                public com.inventrax.tvs.services.appupdate.NotificationConfirmationStrategy[] newArray(int size) {
                    return (new com.inventrax.tvs.services.appupdate.NotificationConfirmationStrategy[size]);
                }
            };
