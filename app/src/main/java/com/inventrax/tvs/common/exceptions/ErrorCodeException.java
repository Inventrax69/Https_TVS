...
public class ErrorCodeException extends AbstractException {
    ...
    public com.inventrax.tvs.common.exceptions.ErrorCodeException setTrackable(Boolean trackable) {
        return (com.inventrax.tvs.common.exceptions.ErrorCodeException)super.setTrackable(trackable);
    }
}