package com.inventrax.tvs.common.collections;
...
public class Lists {
    ...
    public static <E> List<E> safeArrayList(List<E> list) {
        return list != null ? list : com.inventrax.tvs.common.collections.Lists.<E>newArrayList();
    }
    ...
    public static <T> List<T> trim(List<T> list, int maxCount) {
        if (list.size() > maxCount) {
            return com.inventrax.tvs.common.collections.Lists.newArrayList(list.subList(0, maxCount));
        }
        return list;
    }
