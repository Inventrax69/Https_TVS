...
import com.inventrax.jungheinrich.fragments.WorkorderRevertFragment;
import com.inventrax.jungheinrich.pojos.OutbountDTO;

import java.util.List;

public class WorkOrderAdapter extends RecyclerView.Adapter<com.inventrax.jungheinrich.adapters.WorkOrderAdapter.Recycle> {
    Context context;
