...
import com.inventrax.jungheinrich.model.Model;
...
public class DeletePickedItemAdapter extends RecyclerView.Adapter<com.inventrax.jungheinrich.adapters.DeletePickedItemAdapter.ViewHolder> {
  ...
  static AlertDialog.Builder alertDialog;
    ...
    @Override
    public com.inventrax.jungheinrich.adapters.DeletePickedItemAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(com.inventrax.jungheinrich.adapters.DeletePickedItemAdapter.ViewHolder holder, int position) {
