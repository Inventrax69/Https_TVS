...
public class PickingExpandableListAdapter extends BaseExpandableListAdapter {

    private Context _context;
    private List<String> _listDataHeader; // header titles
    private List<OutbountDTO> lstOutbound; // header titles
    ...
    public PickingExpandableListAdapter(FragmentActivity fragmentActivity, Context context, List<OutbountDTO> lstOutbound ) {
...
//        this._listDataChild = listChildData;
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.pickinglistitem, null);
        }
        ...
        btnPutaway.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FragmentUtils.replaceFragmentWithBackStack(fragmentActivity, R.id.container_body, PickingDetailsFragment);
