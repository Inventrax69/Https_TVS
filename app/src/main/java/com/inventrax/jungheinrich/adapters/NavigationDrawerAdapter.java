...
public class NavigationDrawerAdapter extends RecyclerView.Adapter<com.inventrax.jungheinrich.adapters.NavigationDrawerAdapter.MyViewHolder> {
    ...
    public static void setSelectedItemPosition(int selectedItemPosition) {
        com.inventrax.jungheinrich.adapters.NavigationDrawerAdapter.selectedItemPosition = selectedItemPosition;
    }
