package com.inventrax.jungheinrich.pojos;
...
public class OutbountDTO implements Serializable {
    ...
    @SerializedName("IsMoreOptions")
    private String IsMoreOptions;
    ...
    public OutbountDTO(Set<? extends Map.Entry<?, ?>> entries) {
        for (Map.Entry<?, ?> entry : entries) {
            ...
            switch (entry.getKey().toString()) {
                ...
                case "IsPSN":
                    if (entry.getValue() != null) {
                        this.setIsPSN(entry.getValue().toString());
                    }
                    break;
                ...
                case "IsMoreOptions":
                    if (entry.getValue() != null) {
                        this.setIsMoreOptions(entry.getValue().toString());
                    }
                    break;
    ...
    public String getIsPSN() {
        return IsPSN;
    }

    public void setIsPSN(String isPSN) {
        IsPSN = isPSN;
    }
    ...
    public String getIsMoreOptions() {
        return IsMoreOptions;
    }

    public void setIsMoreOptions(String isMoreOptions) {
