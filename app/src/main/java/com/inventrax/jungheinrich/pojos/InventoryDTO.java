...
public class InventoryDTO {
    ...
    @SerializedName("SugLocation")
    private String SugLocation;
    ...
    public InventoryDTO(Set<? extends Map.Entry<?, ?>> entries) {
        for (Map.Entry<?, ?> entry : entries) {
            ...
            switch (entry.getKey().toString()) {
                ...
                case "SugLocation":
                    if (entry.getValue() != null) {
                        this.setSugLocation(entry.getValue().toString());
                    }
                    break;
    ...
    public String getSugLocation() {
        return SugLocation;
    }

    public void setSugLocation(String sugLocation) {
