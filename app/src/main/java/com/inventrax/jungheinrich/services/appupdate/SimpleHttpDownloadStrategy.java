...
public class SimpleHttpDownloadStrategy implements DownloadStrategy {
    public static final Creator<com.inventrax.jungheinrich.services.appupdate.SimpleHttpDownloadStrategy> CREATOR =
            new Creator<com.inventrax.jungheinrich.services.appupdate.SimpleHttpDownloadStrategy>() {
                public com.inventrax.jungheinrich.services.appupdate.SimpleHttpDownloadStrategy createFromParcel(Parcel in) {
                    return (new com.inventrax.jungheinrich.services.appupdate.SimpleHttpDownloadStrategy());
                }

                public com.inventrax.jungheinrich.services.appupdate.SimpleHttpDownloadStrategy[] newArray(int size) {
                    return (new com.inventrax.jungheinrich.services.appupdate.SimpleHttpDownloadStrategy[size]);
                }
            };
