...
package com.inventrax.jungheinrich.services.appupdate;
...
public class NotificationConfirmationStrategy implements
     ...
     * upon demand.
     */
    public static final Creator<com.inventrax.jungheinrich.services.appupdate.NotificationConfirmationStrategy> CREATOR =
            new Creator<com.inventrax.jungheinrich.services.appupdate.NotificationConfirmationStrategy>() {
                public com.inventrax.jungheinrich.services.appupdate.NotificationConfirmationStrategy createFromParcel(Parcel in) {
                    return (new com.inventrax.jungheinrich.services.appupdate.NotificationConfirmationStrategy(in));
                }

                public com.inventrax.jungheinrich.services.appupdate.NotificationConfirmationStrategy[] newArray(int size) {
                    return (new com.inventrax.jungheinrich.services.appupdate.NotificationConfirmationStrategy[size]);
                }
            };
