...
public class SimpleHttpVersionCheckStrategy implements
     ...
     * upon demand.
     */
    public static final Creator<com.inventrax.jungheinrich.services.appupdate.SimpleHttpVersionCheckStrategy> CREATOR =
            new Creator<com.inventrax.jungheinrich.services.appupdate.SimpleHttpVersionCheckStrategy>() {
                public com.inventrax.jungheinrich.services.appupdate.SimpleHttpVersionCheckStrategy createFromParcel(Parcel in) {
                    return (new com.inventrax.jungheinrich.services.appupdate.SimpleHttpVersionCheckStrategy(in));
                }

                public com.inventrax.jungheinrich.services.appupdate.SimpleHttpVersionCheckStrategy[] newArray(int size) {
                    return (new com.inventrax.jungheinrich.services.appupdate.SimpleHttpVersionCheckStrategy[size]);
                }
            };
