package com.inventrax.jungheinrich.common.collections;
...
public class Lists {
    ...
    public static <E> List<E> safeArrayList(List<E> list) {
        return list != null ? list : com.inventrax.jungheinrich.common.collections.Lists.<E>newArrayList();
    }
    ...
    public static <T> List<T> trim(List<T> list, int maxCount) {
        if (list.size() > maxCount) {
            return com.inventrax.jungheinrich.common.collections.Lists.newArrayList(list.subList(0, maxCount));
        }
        return list;
    }
...
/*    public static <T> List<T> filter(List<T> unfilteredList, Predicate<T> predicate) {
        List<T> filteredList = com.inventrax.gsknewCo.common.collections.Lists.newArrayList();
