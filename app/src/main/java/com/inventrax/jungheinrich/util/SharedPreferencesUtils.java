...
public class SharedPreferencesUtils {
    ...
    private static com.inventrax.jungheinrich.util.SharedPreferencesUtils defaultSharedPreferencesHelper = new com.inventrax.jungheinrich.util.SharedPreferencesUtils(null, null);
    ...
    public static com.inventrax.jungheinrich.util.SharedPreferencesUtils get(String name, Context context) {
        return new com.inventrax.jungheinrich.util.SharedPreferencesUtils(name, context);
    }

    public static com.inventrax.jungheinrich.util.SharedPreferencesUtils get() {
