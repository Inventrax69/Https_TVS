...
public class AndroidUtils {
    ...
    public static String getDeviceSerialNumber(ContentResolver contentResolver) {
        String deviceId = null;

        if (Build.VERSION.SDK_INT >= 29) {
            // For Android 10 and above, use Android ID as an alternative
            deviceId = Settings.Secure.getString(contentResolver, Settings.Secure.ANDROID_ID);
        } else {
            // For versions prior to Android 10, you can still use Build.SERIAL
