...
public class NetworkUtils {
    ...
    public static String getConnectivityStatusAsString(Context context) {
        int conn = com.inventrax.jungheinrich.util.NetworkUtils.getConnectivityStatus(context);
        String status = null;
        if (conn == com.inventrax.jungheinrich.util.NetworkUtils.TYPE_WIFI) {
            status = "Wifi enabled";
        } else if (conn == com.inventrax.jungheinrich.util.NetworkUtils.TYPE_MOBILE) {
            status = "Mobile data enabled";
        } else if (conn == com.inventrax.jungheinrich.util.NetworkUtils.TYPE_NOT_CONNECTED) {
    ...
    public static boolean getConnectivityStatusAsBoolean(Context context) {
        int connectionType = com.inventrax.jungheinrich.util.NetworkUtils.getConnectivityStatus(context);
        boolean status = false;
        if (connectionType == com.inventrax.jungheinrich.util.NetworkUtils.TYPE_WIFI) {
            status = true;
        } else if (connectionType == com.inventrax.jungheinrich.util.NetworkUtils.TYPE_MOBILE) {
            status = true;
        } else if (connectionType == com.inventrax.jungheinrich.util.NetworkUtils.TYPE_NOT_CONNECTED) {
            status = false;
        }
        return status;
    }
    ...
    public static boolean isWiFiEnabled(Context context) {
        return com.inventrax.jungheinrich.util.NetworkUtils.getConnectivityStatus(context) == com.inventrax.jungheinrich.util.NetworkUtils.TYPE_WIFI;
    }
    ...
    public static boolean isMobileDataEnabled(Context context) {
        return com.inventrax.jungheinrich.util.NetworkUtils.getConnectivityStatus(context) == com.inventrax.jungheinrich.util.NetworkUtils.TYPE_MOBILE;
    }
...
*/          final ConnectivityManager connectivityManager = ((ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE));
    ...
    static class InternetAvailabilityCheckTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            com.inventrax.jungheinrich.util.NetworkUtils.isInternetAvailable=aBoolean;
        }
    }
