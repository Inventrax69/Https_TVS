...
public class ScreenUtils {
    ...
    public static String getScreenDensity() {
        ...
        if (com.inventrax.jungheinrich.util.ScreenUtils.isLdpiDensity()) {
            density = LDPI_DENSITY_NAME;
        } else if (com.inventrax.jungheinrich.util.ScreenUtils.isMdpiDensity()) {
            density = MDPI_DENSITY_NAME;
        } else if (com.inventrax.jungheinrich.util.ScreenUtils.isHdpiDensity()) {
            density = HDPI_DENSITY_NAME;
        } else if (com.inventrax.jungheinrich.util.ScreenUtils.isXhdpiDensity()) {
            density = XHDPI_DENSITY_NAME;
        } else if (com.inventrax.jungheinrich.util.ScreenUtils.isTVdpiDensity()) {
            density = TVDPI_DENSITY_NAME;
        } else if (com.inventrax.jungheinrich.util.ScreenUtils.isXXhdpiDensity()) {
            density = XXHDPI_DENSITY_NAME;
        } else if (com.inventrax.jungheinrich.util.ScreenUtils.isXXXhdpiDensity()) {
